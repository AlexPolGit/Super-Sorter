...
from domain.objects.models.sortable import SortableItem, SortableItemData
...
class AnilistCharacterData(SortableItemData):
    name_full: str
    name_native: str
    image: str

class AnilistStaffData(SortableItemData):
    name_full: str
    name_native: str
    image: str

class AnilistMediaData(SortableItemData):
    image: str
    title_romaji: str
    title_english: str
    title_native: str
