...
import { AnilistMediaFilter, AnilistMediaFilterSettings } from '../filters/anilist-media-filter';
...
export class AnilistMediaListComponent extends ItemListComponent<AnilistMediaSortable> {
